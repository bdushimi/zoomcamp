...
drop table if exists nyc_prediction_model_metrics;
create table nyc_prediction_model_metrics(
	timestamp timestamp,
...
def calculate_metrics_postgresql(curr, i):
    ...
    curr.execute(
        "insert into nyc_prediction_model_metrics(timestamp, prediction_drift, num_drifted_columns, share_missing_values) values (%s, %s, %s, %s)",
